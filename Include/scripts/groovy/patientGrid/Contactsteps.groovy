...
class Contactsteps {
	...
	def deleteguardian(String lastname) {
		...
		System.out.println("befofore delete s1= " +s1)
	...
	def very_deleted_contac_UIguardian(){
		...
		s2=Table2.size()
		System.out.println("after delete s2= " +s2)
		System.out.println("after delete s1= " +s1)
		s1 = s1-1
		System.out.println("after delete and subtract s1= " +s1)
		Thread.sleep(1000)
		WebUI.verifyEqual(s1, s2)
		WebUI.switchToDefaultContent()
	}
