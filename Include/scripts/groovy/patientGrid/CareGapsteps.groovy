...
//		Stringtext.planetext('101010')
	...
	def deletedtaskgoal_alert_should_popup() {
		WebUI.waitForElementClickable(findTestObject('Object Repository/OR_PatientGrid/OR_PatientData/OR_CareGap/OR_Goal/Obj_AlertGoaldelete'), 30)
		Thread.sleep(1000)
...
//		Thread.sleep(1000)
	...
	def validatedatacaregap(String caregap) {
		...
		if(guidline=='') {
			...
			WebUI.verifyElementText(findTestObject('Object Repository/OR_PatientGrid/OR_PatientData/OR_CareGap/Obj_td_Guidline'), '')
		}
		else {
		...
		if(severity=='') {
			...
			WebUI.verifyElementText(findTestObject('Object Repository/OR_PatientGrid/OR_PatientData/OR_CareGap/Obj_td_severity'), '')
		}
		else {
		...
		if(refernces=='') {
			...
			WebUI.verifyElementText(findTestObject('Object Repository/OR_PatientGrid/OR_PatientData/OR_CareGap/Obj_td_references'), '')
		}
		else {
