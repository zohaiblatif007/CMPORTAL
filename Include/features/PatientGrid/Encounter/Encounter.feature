...
#		And I should see the newly created encounter on grid
    ...
    |Adam, Andrew  |  C4  |  Yes   |Observation care, typically 30 minutes are spent::99218|12192020 01:30:00 AM|12072021 01:30:00 AM|Production_facility|    SNF    |    SNF 1    |pakistan|Allergy clinic|Telehealth|Referral Note|Zohaib, Muhammad| provider, prod |    A JAFFER    |   
...
#		And I should see the newly created encounter on grid
    ...
    Examples:
    |    Patient     |Source|Billable|                          Encounter                    |      StartDate     |       EndDate      |   ServingFacility |  Disposition| Disfacility |Location|      POS     | VisitType|   NoteType  | ApptProvider   |RendringProvider|RefrenceProvider|   
    |Adam, Andrew  |  C4  |  Yes   |Observation care, typically 30 minutes are spent::99218|12192020 01:30:00 AM|12072021 01:30:00 AM|Production_facility|     SNF     |     SNF 2   |pakistan|Allergy clinic|Telehealth|Referral Note|Zohaib, Muhammad|  provider, prod|    A JAFFER    |   
...
#		And I should see deleted encounter not present on grid
    ...
    Examples:
    |    Patient     |                       Encounter                       |
    |Adam, Andrew  |Observation care, typically 30 minutes are spent::99218|
