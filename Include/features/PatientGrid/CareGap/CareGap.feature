...
Given I search <Patient> using global search
  ...
  *   I click on patient task tab in main menu
  ...
  |MILLER, GARY LEE|Pulmonary rehabilitation|do jim every day|03202021 04:54 AM|04202021 04:54 AM|In Progress|Task created from caregap|
  ...
  *   I click on patient task tab in main menu
  And I should see task <Taskname> with status <Status> and start date <Strtdate> end date <Completeddate> present in task section
    ...
    Examples: 
      ...
      |MILLER, GARY LEE|Pulmonary rehabilitation| Task created | 03202021 04:54 AM | 04202021 04:54 AM | In Progress | Task created from caregap | Daily      |    3 |         4 |
  ...
  *   I click on patient task tab in main menu
  And I should see task <Taskname> with status <Status> and start date <Strtdate> end date <Completeddate> present in task section
    ...
    Examples: 
      ...
      |MILLER, GARY LEE|Pulmonary rehabilitation| Task created | 03202021 04:54 AM | 04202021 04:54 AM | In Progress | Task created from caregap | Weekly     |     3 |         4 |
  ...
  *   I click on patient task tab in main menu
  And I should see task <Taskname> with status <Status> and start date <Strtdate> end date <Completeddate> present in task section
    ...
    Examples: 
      ...
      |MILLER, GARY LEE|Pulmonary rehabilitation| Task created | 03202021 04:54 AM | 04202021 04:54 AM | In Progress | Task created from caregap | Monthly    |     3 |         4 |
  ...
  *   I click on patient task tab in main menu
  And I should see task <Taskname> with status <Status> and start date <Strtdate> end date <Completeddate> present in task section
    ...
    Examples: 
      ...
      |MILLER, GARY LEE|Pulmonary rehabilitation| Task created | 03202021 04:54 AM | 04202021 04:54 AM | In Progress | Task created from caregap | Yearly     |    3 |         4 |
  ...
  And I click on patient goal tab in PWB
    ...
    *   I click on yes button to cofirm delete goal task
    ...
    Examples: 
      ...
      |MILLER, GARY LEE|Pulmonary rehabilitation| Goal is to cure in a week | ST             |     04012021 |    04222021 | Normal Priority | Provider  | Goal has created | Blood pressure |      03122021 |   4122021 | High         | Active     | Goal and Task Created by gaol and task |
...
Given I search <Patient> using global search
 ...
 Then I should see success message for created Goal
  ...
  And I click on patient goal tab in PWB
    ...
    *   I click on yes button to cofirm delete goal task
    ...
    Examples: 
      ...
      |MILLER, GARY LEE|Pulmonary rehabilitation| Goal is to cure in a week | ST             |     04022021 |    04222021 | Normal Priority | Provider  | Goal has created |
  ...
  Scenario Outline: Create task of a patient
    ...
    *   I click on yes button to cofirm delete goal task
    ...
    Examples: 
      ...
      |MILLER, GARY LEE| Blood pressure |Pulmonary rehabilitation|      08102021 |   8312021 | High         | Active     | Task Created by gaol and task |
  ...
  Scenario Outline: validate the data of a care gap
    ...
    Examples: 
      |  Patient       |    Care_Gap                                          |
      |MILLER, GARY LEE|Pulmonary rehabilitation|
  ...
  Scenario Outline: status change to closed of an open care gap
   ...
   Examples: 
      ...
      |MILLER, GARY LEE|Pulmonary rehabilitation| Open  | Follow up with patient |              |
      |MILLER, GARY LEE|Pulmonary rehabilitation|Closed | Follow up with patient | Goal Created |
      |MILLER, GARY LEE|Pulmonary rehabilitation| Open  | Follow up with patient |              |
  ...
  Scenario Outline: status change to closed of an open care gap with cross button
    ...
    * I click on save button to close care gap
    ...
    Examples: 
      ...
      |MILLER, GARY LEE|Pulmonary rehabilitation|Closed |Goal Created|
