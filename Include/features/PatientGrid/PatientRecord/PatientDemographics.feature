...
Background: 
  Given I navigate to patient grid
    ...
    *   I click on patient save button
    ...
    |Robeb|   anar67   |   ahi77   |  K29ri   |  Mr  |  Wikllian |Male|12032020|     Female    |Straight or Heterosexual|   Lahore   | Punjab   |  Pakistan  |    Married   |English |Asian|  Pakistani  |Hispanic or Latino|    Asturian      | Islam  |Suuport test SNF| Thiokar niaz | north punjab|   Punjab    |    0123   |  Near Iran    |0139848973|0174888888|013344333333|       Home    |test@ss.com|add new patient|   
...
#		*   I enter <Ethnicity> in patient record ethnicity field
    ...
    *   I click on patient record Update button
    ...
    |     amiredit     |   amiredit  |   Deni     |   khan  | Mrs  |  William |Active|Robit|Female|Abkhazian|Straight or Heterosexual|     Female    |  Acoma      |Asian|    Asturian      |Hispanic or Latino|Interlocutory | Islam  |   DENESE IRISH    |   Lahore   | Punjab   |  Pakistan  | Thiokar niaz | north punjab|   Punjab    |    0123   |  Near Iran    |0139848973|0174888888|013344333333|       Home    |test@ss.com|Edit patient record|   
